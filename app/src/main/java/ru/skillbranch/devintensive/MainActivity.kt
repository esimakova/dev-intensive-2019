...
class MainActivity : AppCompatActivity(), View.OnClickListener {
     ...
     * Инициализируются представления, которые связываются с необходимыми данными и ресурсами.
     * Связываются данные со списками.
     *
     * Этот метод также предоставляет Bundle, содержащий ранее сохранённое состояние Activity, если оно было.
     *
     ...
     * Запуск потоков, остлеживания показаний датчиков, запросов к GPS, таймеров, сервисов или других процессов,
     ...
     * сохранение в базу данных, если данные должны быть доступны в новой Aktivity
    ...
    /**
     * Метод вызывается по окончании работы Aktivity, при вызове метода finish() или в случае,
